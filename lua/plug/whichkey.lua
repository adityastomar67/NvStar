...
local n_mappings = {
	...
	p = {
		...
		c    = { "<cmd>PackerCompile profile=true<cr>" , "漏Recompile Plugins" }     ,
		i    = { "<cmd>PackerInstall<cr>"              , " Install Plugins" }       ,
		p    = { "<cmd>PackerProfile<cr>"              , "ףּ Packer Profile" }        ,
		s    = { "<cmd>PackerSync<cr>"                 , " Sync Plugins" }          ,
		S    = { "<cmd>PackerStatus<cr>"               , " Packer Status" }         ,
		u    = { "<cmd>PackerUpdate<cr>"               , "ﮮ Update Plugins" }        ,
	},
	s = {
		name = "Something Else",
	...
	l = {
		name = "LSP",
		R    = { "<cmd>Trouble lsp_references<cr>"                                  , "בּ Trouble References" }        ,
		a    = { "<cmd>lua vim.lsp.buf.code_action()<CR>"                           , " Code Action" }               ,
		d    = { "<cmd>lua require('telescope.builtin').diagnostics()<CR>"          , " Diagnostics" }               ,
		f    = { "<cmd>Lspsaga lsp_finder<CR>"                                      , " Finder" }                    ,
		i    = { "<cmd>LspInfo<CR>"                                                 , " Lsp Info" }                  ,
		n    = { "<cmd>lua vim.lsp.buf.rename()<CR>"                                , "ﯕ Rename" }                    ,
	...
	f = {
		...
		b        = { '<cmd>lua require("plug.telescope.options").buffers()<cr>'         , "Buffers" }          ,
		d        = { '<cmd>lua require("plug.telescope.options").xdg_config()<cr>'      , "Dotfiles" }         ,
		n        = { '<cmd>lua require("plug.telescope.options").nvim_files()<cr>'      , "Nvim Files" }       ,
		r        = { '<cmd>lua require("plug.telescope.options").search_oldfiles()<cr>' , "Recently Opened" }  ,
