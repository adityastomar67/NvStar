...
Theme.plugins = function()
  ...
  local cmp = {
    ...
    CmpItemKindField         = { fg = "#EED8DA", bg   = c.none },
    CmpItemKindProperty      = { fg = "#EED8DA", bg   = c.none },
    CmpItemKindEvent         = { fg = "#EED8DA", bg   = c.none },
    CmpItemKindText          = { fg = "#C3E88D", bg   = c.none },
    CmpItemKindEnum          = { fg = "#C3E88D", bg   = c.none },
    CmpItemKindKeyword       = { fg = "#C3E88D", bg   = c.none },
    CmpItemKindConstant      = { fg = "#FFE082", bg   = c.none },
    CmpItemKindConstructor   = { fg = "#FFE082", bg   = c.none },
    CmpItemKindReference     = { fg = "#FFE082", bg   = c.none },
    CmpItemKindFunction      = { fg = "#EADFF0", bg   = c.none },
    CmpItemKindStruct        = { fg = "#EADFF0", bg   = c.none },
    CmpItemKindClass         = { fg = "#EADFF0", bg   = c.none },
    CmpItemKindModule        = { fg = "#EADFF0", bg   = c.none },
    CmpItemKindOperator      = { fg = "#EADFF0", bg   = c.none },
    CmpItemKindVariable      = { fg = "#C5CDD9", bg   = c.none },
    CmpItemKindFile          = { fg = "#C5CDD9", bg   = c.none },
    CmpItemKindUnit          = { fg = "#F5EBD9", bg   = c.none },
    CmpItemKindSnippet       = { fg = "#F5EBD9", bg   = c.none },
    CmpItemKindFolder        = { fg = "#F5EBD9", bg   = c.none },
    CmpItemKindMethod        = { fg = "#DDE5F5", bg   = c.none },
    CmpItemKindValue         = { fg = "#DDE5F5", bg   = c.none },
    CmpItemKindEnumMember    = { fg = "#DDE5F5", bg   = c.none },
    CmpItemKindInterface     = { fg = "#D8EEEB", bg   = c.none },
    CmpItemKindColor         = { fg = "#D8EEEB", bg   = c.none },
    CmpItemKindTypeParameter = { fg = "#D8EEEB", bg   = c.none },
  }
  local gitsigns = {
